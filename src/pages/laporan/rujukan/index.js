...
import { URLKonseling, URLRujukan } from '../../../utils/storedata/storedata';
export default function FromRoujukan({navigation}) {
    ...
    color: selectedDateTextColor
     ...
     <PickerDate/>
        ...
        <View style={{marginTop:20}}>
            ...
            paddingLeft:10, color:'black', fontFamily:"Poppins-Regular", fontSize:12}} placeholder='Kepemilikan JKN' placeholderTextColor='gray'
         ...
         <View style={{marginTop:20}}>
            ...
            <TextInput style={{backgroundColor:'#f5f5f5', borderWidth:1, borderRadius:5, height:40, paddingRight:10, 
            paddingLeft:10, color:'black', fontFamily:"Poppins-Regular", fontSize:12}} placeholder='Fasilitas Yang Dijadikan Rujukan' placeholderTextColor='gray'
