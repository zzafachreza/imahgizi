...
export default function FromKonseling({navigation}) {
    ...
    color: selectedDateTextColor
     ...
     <PickerDate/>
        ...
        <View style={{marginTop:20}}>
            ...
            paddingLeft:10, color:'black', fontFamily:"Poppins-Regular", fontSize:12}} placeholder='Materi Konseling' placeholderTextColor='gray'
                value={form.materikonseling}  onChangeText={value => setForm({...form,materikonseling: value})}
            />
        </View>
